...
We first define a DNA fragment length distribution function. Here we estimate the standard deviation of the length distribution from the range
\begin{equation}
...
We then generate read densities for the forward and reverse strand using the binding site densities `dens` and DNA fragment length distribution function `fragLength`. 
```{r}
